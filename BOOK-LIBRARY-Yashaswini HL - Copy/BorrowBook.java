...
/*
 * This class is for storing borrowable books which extends the read-only book for getting the properties from that class.
 */
public class BorrowBook extends ReadBook {
